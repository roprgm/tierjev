...
Biome formats and lints (2-space indent, single quotes, no semicolons) and enforces kebab-case file names. `bun run check` runs it with the type checker.
