...
export function ModalSurface({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      className={cn(
        'fixed top-1/2 left-1/2 z-50 flex max-h-[calc(100dvh-3rem)] w-[28rem] max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2 flex-col gap-5 overflow-y-auto rounded-2xl border bg-control p-6 text-foreground shadow-xl shadow-black/40 ring-1 ring-black/30 outline-none',
