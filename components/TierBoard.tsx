        ...
        {rows.map(({ tier, placed }, rowIndex) => (
          <div key={tier} className="flex h-22 border-b last:border-b-0">
            ...
            <div
              ...
              className="scrollbar-none flex min-w-0 flex-1 gap-1 overflow-x-auto overflow-y-hidden overscroll-x-contain bg-muted/40 p-1"
            >
              {placed.map((p, i) => (
                <ItemTile
                  key={p.name}
