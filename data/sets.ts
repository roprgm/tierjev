...
export const SETS: TierSet[] = [
  set(
    ...
    'Best language to learn first in 2026',
  ...
  set(
    ...
    '⚛️',
    'Frontend frameworks',
    'Best for shipping a startup fast',
  ...
  set(
    ...
    '🍎',
    'Fruits',
    'Best fruit for a summer picnic',
  ...
  set(
    ...
    '🪐',
    'Solar system',
    'Most habitable place for a future colony',
  ...
  set(
    ...
    '🗄️',
    'Databases',
    'Best default for a new web app',
